...
#define P_FLAG_SUMMARY_SCREEN_IV_EV_INFO    0x20 
#define I_EXP_SHARE_FLAG     0x21
...
#define FLAG_INVERSE_BATTLE 0x2BB
...
#define FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_HOUSE_MOM                 0x468
