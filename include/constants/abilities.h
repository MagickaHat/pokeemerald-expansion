...
#define ABILITY_MOUNTAINEER         (ABILITIES_COUNT_GEN9 + 2)
#define ABILITY_SAND_SONG           (ABILITIES_COUNT_GEN9 + 3)
#define ABILITY_FLAMING_SOUL        (ABILITIES_COUNT_GEN9 + 4)
#define ABILITY_SOUND_WAVES         (ABILITIES_COUNT_GEN9 + 5)
#define ABILITY_JETSTREAM           (ABILITIES_COUNT_GEN9 + 6)
#define ABILITY_SUPER_SLAMMER       (ABILITIES_COUNT_GEN9 + 7)
#define ABILITY_AROMATIC_MIST       (ABILITIES_COUNT_GEN9 + 8) //Shield Dust Copy
#define ABILITY_SPIKY_BARBS         (ABILITIES_COUNT_GEN9 + 9)
#define ABILITY_BONE_ZONE           (ABILITIES_COUNT_GEN9 + 10)
#define ABILITY_SPINNER             (ABILITIES_COUNT_GEN9 + 11)
#define ABILITY_HOARFROST           (ABILITIES_COUNT_GEN9 + 12)
#define ABILITY_NULLIFY             (ABILITIES_COUNT_GEN9 + 13)

#define ABILITIES_COUNT_CUSTOM      (ABILITY_NULLIFY + 1)
