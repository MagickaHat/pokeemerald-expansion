...
#define CUSTOM_NORMAL_ITEMS ITEM_STRANGE_BALL

//Items
#define ITEM_FROST_ORB  (CUSTOM_NORMAL_ITEMS + 1)

#define CUSTOM_NORMAL_ITEMS_END ITEM_FROST_ORB
#define CUSTOM_KEY_ITEMS CUSTOM_NORMAL_ITEMS_END

//Key Items
#define ITEM_FRIENDSHIP_BOX (CUSTOM_KEY_ITEMS + 1)
#define ITEM_TIME_CHANGER (CUSTOM_KEY_ITEMS + 2)
#define ITEM_SILVALLY_CATALOG (CUSTOM_KEY_ITEMS + 3)
#define ITEM_FISHING_ROD (CUSTOM_KEY_ITEMS + 4)
#define ITEM_INF_REPEL (CUSTOM_KEY_ITEMS + 5)

#define CUSTOM_KEY_ITEMS_END ITEM_INF_REPEL
#define CUSTOM_MEGA_STONES CUSTOM_KEY_ITEMS_END

//Mega Stones
//TODO: Add Mega Stones as overworld items.
//#define ITEM_BLASTOISINITE_D 829
#define ITEM_FLYGONITE  (CUSTOM_MEGA_STONES + 1)
#define ITEM_TALONITE   (CUSTOM_MEGA_STONES + 2)
#define ITEM_KINGLERITE (CUSTOM_MEGA_STONES + 3)
#define ITEM_TOXTRICITE (CUSTOM_MEGA_STONES + 4)
#define ITEM_SNORLAXITE (CUSTOM_MEGA_STONES + 5)
#define ITEM_SANDACONDITE (CUSTOM_MEGA_STONES + 6)


#define CUSTOM_MEGA_STONES_END ITEM_SANDACONDITE
#define CUSTOM_ITEMS_END CUSTOM_MEGA_STONES_END

#define ITEMS_COUNT (CUSTOM_ITEMS_END + 1)
