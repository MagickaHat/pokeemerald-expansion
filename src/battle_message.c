...
static const u8 sText_SubstituteDamaged[] = _("The Subsitute took damage\nfor {B_DEF_NAME_WITH_PREFIX}!\p");
...
static const u8 sText_WallyUsedItem[] = _("WAally used\n{B_LAST_ITEM}!");
